...
const sortingRow = ['name', 'speciality', 'year'];

const rows = [
  { id: 'name', numeric: false, disablePadding: true, label: 'ФИО' },
  { id: 'speciality', numeric: false, disablePadding: true, label: 'Специальность' },
...
class EnchantedStudentsTable extends  BaseComponent {
  ...
  handleRemoveClick = (event, student) => {
                          ...
                          {Roles.userIsInRole(user, 'admin')?(
                            <React.Fragment>
                              ...
                              <Tooltip title={"Удалить"}>
                                <IconButton
                                  className={classes.margin}
                                  onClick={e => this.handleRemoveClick(e, n)}
                                >
